    ...
    return (
        <div className="author_wrapper">
            <span className="author_content">
                ...
                <a href="" rel="noopener">
                    <img alt="Zara Stone" className="author_content_avatar_img" src="https://miro.medium.com/fit/c/80/80/1*eB3YZUUB6HQYkBFDvAhwhg.jpeg" width={80} height={80} />
                </a>
                </div>
                <span className="r">
                ...
                <div className="author_content_author_name_wrapper">
                    ...
                    <h2 className="author_name">
                        <a href="" className="author_name_link" rel="noopener">Zara Stone</a>
                    </h2>
            ...
            <div className="author_description_wraper">
                ...
                <h4 className="author_description">Tech + Culture freelance reporter. Ice cream fan. Bylines @theatlantic @vice @forbes @ozy @ozm etc. www.zarastone.net www.twitter.com/almostzara</h4>
                </div>
            </div>
        </div>
    )
